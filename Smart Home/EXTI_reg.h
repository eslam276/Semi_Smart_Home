...
#define MCUCR_ISC00			0u							/*@brief Interrupt sense control sense   0 bit 0  */
#define MCUCR_ISC01			1u							/*@brief Interrupt sense control sense   0 bit 1  */
#define MCUCR_ISC10			2u							/*@brief Interrupt sense control sense   1 bit 0  */
#define MCUCR_ISC11			3u							/*@brief Interrupt sense control sense   1 bit 1  */

#define MCUCSR            	*((volatile uint8*)0x54)    /*@brief MCU control and status register*/
#define MCUCR_ISC2			6u                          /*@brief Interrupt sense control 2 */
#endif /* EXTI_REG_H_ */
